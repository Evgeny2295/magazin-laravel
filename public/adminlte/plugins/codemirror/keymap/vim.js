  ...
  var Vim = function() {
    ...
    var commandDispatcher = {
      ...
      processSearch: function(cm, vim, command) {
        if (!cm.getSearchCursor) {
          // SearchProduct depends on SearchCursor.
          return;
        }
    ...
    * in the right place.
    ...
    function charIdxInLine(start, line, character, forward, includeChar) {
      // SearchProduct for char in line.
    ...
    var exCommands = {
      ...
      substitute: function(cm, params) {
        if (!cm.getSearchCursor) {
          throw new Error('SearchProduct feature not available. Requires searchcursor.js or ' +
