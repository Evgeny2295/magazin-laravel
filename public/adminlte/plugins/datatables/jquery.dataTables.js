...
(function( $, window, document, undefined ) {
	...
	function _fnFilter( settings, input, force, regex, smart, caseInsensitive )
	{
		...
		if ( input.length <= 0 ) {
			...
			// SearchProduct the display array
			...
			if ( ! row._aFilterData ) {
				...
				for ( j=0, jen=columns.length ; j<jen ; j++ ) {
					...
					if ( column.bSearchable ) {
						...
						// SearchProduct in DataTables 1.10 is string based. In 1.11 this
	...
	DataTable.defaults = {
		...
		/**
		 * SearchProduct delay option. This will throttle full table searches that use the
